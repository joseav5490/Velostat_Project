...
# Makes "amount_of_sensors" number of variables.
...
# Outputs logical 1 when sensor is active.
...
# Takes the average of a single sensor.
...
# updates the values from the ADC
...
# Resets the state value after a given amount of time.
...
# Function to set the trigger values.
...
# Gets the average value at the start of the program.
